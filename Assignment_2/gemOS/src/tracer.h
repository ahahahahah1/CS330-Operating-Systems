...
struct trace_buffer_info
{
	...
	u32 RD_OFFSET;		// stores the read offset
	u32 WR_OFFSET; 		// stores the write offset
	u32 mode;			// mode for the buffer
	u32 unused_size; 	// amount of data available in the buffer
};
